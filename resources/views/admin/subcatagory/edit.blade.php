                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select name="catagory_id" id="category" class="form-control">
                                        ...
                                        <option value="{{ $cat->id }}" {{($cat->id == $subCatagory->catagory->id)? "selected" : ""}}>{{ $cat->name}}</option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $subCatagory->name }}" name="name" id="name" class="form-control" placeholder="Name">
                                    <p></p>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $subCatagory->slug }}" name="slug" id="slug" class="form-control" placeholder="Slug">
                                    <p></p>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="category" class="form-control">
                                        ...
                                        <option {{($subCatagory->status) ? "" : "selected"}} value="0">Block</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#catagoryform").submit(function (e) {
        ...
        $.ajax({
            url:"{{ route('subcatagory.update',$subCatagory->id) }}",
            type:"put",
