								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="name" value="{{ $catagory->name }}" id="name" class="form-control" placeholder="Name">	
                                            <p></p>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="slug" value="{{ $catagory->slug }}" id="slug" class="form-control" placeholder="Slug">
                                            <p></p>	
										</div>
									</div>	
									<div class="col-md-6 mb-3">
                                        ...
                                        <img src="{{ asset("uploads/catagory/thumb/".$catagory->amage) }}" class="mt-2" alt="there is no thumbnail for this catagory" height ="300px" width="300px">
                                        @endif
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<!-- <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug">
                                             ...
                                             <select name="status" id="status" class="form-control">
                                                ...
                                                <option {{ ($catagory->status==0) ?  "selected" :  "" }} value="0">block</option>
                                             </select>
										</div>
									</div>	
									<div class="col-md-6">
										<div class="mb-3">
											<label for="show_home">Show Home</label>
                                             <select name="show_home" id="show_home" class="form-control">
                                                ...
                                                <option value="No" {{ ($catagory->show_home == "No") ?  "selected" :  "" }}>No</option>
                                             </select>
										</div>
									</div>								
								</div>
...
@section("customJs")
   ...
   <script>
     ...
     $("#catagoryform").submit(function(e){
        ...
        $.ajax({
            url:"{{ route('catagories.update',["id"=>$catagory->id]) }}",
            type:"put",
