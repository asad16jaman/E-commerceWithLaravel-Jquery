								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->code }}" name="code" id="code" class="form-control" placeholder="coupon code">	
                                            <p></p>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->name }}" name="name" id="name" class="form-control" placeholder="code name">
                                            <p></p>	
										</div>
									</div>	
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->max_uses }}" name="max_uses" id="max_uses" class="form-control" placeholder="max uses">
                                            <p></p>	
										</div>
									</div>	
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->max_uses_user }}" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="max uses user">
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->discount_amount }}" name="discount_amount" id="discount_amount" class="form-control" placeholder="discount amount">
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->min_amount }}" name="min_amount" id="min_amount" class="form-control" placeholder="Min amount">
                                            <p></p>	
										</div>
									</div>
										...
										<div class="mb-3">
											<label for="email">Status</label>
                                             <select name="status" id="status" class="form-control">
                                                ...
                                                <option {{($data->type == "0") ? 'selected' : "" }} value="0">block</option>
                                             </select>
										</div>
									</div>	
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->starts_at }}" name="starts_at" id="starts_at" class="form-control" placeholder="starts at">
                                            <p></p>	
										</div>
									</div>
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" value="{{ $data->expires_at }}" name="expires_at" id="expires_at" class="form-control" placeholder="expires_at">
                                            <p></p>	
										</div>
									</div>
   ...
   <script>
    ...
    $(document).ready(function(){
     ...
     $("#discountForm").submit(function(e){
        ...
        $.ajax({
            url:"{{ route('coupon.update',['id' => $data->id]) }}",
            type:"put",
